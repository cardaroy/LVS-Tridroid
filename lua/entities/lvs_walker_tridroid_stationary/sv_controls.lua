...
-- Body sway offsets for 3-leg gait
-- Leg 1 (Front): body tilts backward
-- Leg 2 (Rear Left): body tilts forward-right
-- Leg 3 (Rear Right): body tilts forward-left
local MoveX = {
	[1] = -1,
	[2] = 0.5,
	[3] = 0.5,
